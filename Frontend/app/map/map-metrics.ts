...
export const metricConfigs: Record<MetricKey, MetricConfig> = {
  ...
  recycle: {
    ...
    hint: "Placeholder μέχρι να συνδεθεί πραγματικό recycle index.",
...
export const metricModalContent: Record<MetricKey, MetricModalContent> = {
  ...
  recycle: {
    button: "Τι είναι το recycle index;",
    title: "Επεξήγηση Recycle Index",
    placeholder:
      "Placeholder modal για recycle index. Εδώ θα μπει η τελική μεθοδολογία όταν συνδεθεί με πραγματικά δεδομένα.",
  },
}
