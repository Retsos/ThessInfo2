                ...
                <div className="grid gap-10 md:grid-cols-[1.2fr_0.9fr_1fr]">
                    <div className="max-w-md">
                        ...
                        <p className="mt-4 text-sm leading-7 text-[#1a535c]/80">
                            ...
                            τοπικό προσανατολισμό και πιο ήρεμη αισθητική. Γιατί δεν χρειάζεται
                            κάθε civic app να μοιάζει είτε με βαρετό portal είτε με startup που
                            ανακάλυψε gradients χθες.
                        </p>
                    </div>
